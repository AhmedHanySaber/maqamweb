    ...
    return (
        <>
            <Button
                type="button"
                onClick={handleOpen}
                className="w-full px-4 py-3 text-center text-gray-100 bg-blue-600 border border-transparent dark:border-gray-700 hover:border-blue-500 hover:text-pink-700 hover:bg-blue-100 rounded-xl"
            >
                Buy now
            </Button>
                ...
                <DialogBody className="">
                    ...
                    <div className="">
                        <Button
                            ...
                            className="w-full px-4 py-3 text-center text-gray-100 bg-blue-600 border border-transparent dark:border-blue-700 rounded-lg"
                        >
                            Buy now
                        </Button>
                    </div>
